...
Бот принимает три вида сообщений:

```
9702020445                            только ИНН
9702020445 Flowwow                    ИНН и бренд
9702020445 Flowwow, доставка цветов   ИНН, бренд и род занятий
```

Бренд стоит дописывать всегда, когда он пишется не так, как в реестре.
В реестре «ООО ФЛАУВАУ», а нейросети и поиск знают Flowwow — без
подсказки проверка покажет ноль упоминаний на ровном месте. Род занятий
дописывают, когда ОКВЭД у компании формальный и запросы вышли не по теме:
программа печатает первый вопрос, по нему сразу видно.
