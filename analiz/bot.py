...
HELP = (
    ...
    'Если бренд пишется не так, как в реестре, добавьте его через '
    'пробел — иначе проверка ничего не найдёт:\n'
    '9702020445 Flowwow\n\n'
    'А если справочник не понял род занятий, допишите его через '
    'запятую:\n'
