...
HELP = (
    ...
    'город с районами, сайт, конкуренты и запросы, которыми его ищут. '
    'Всё это я тоже использую: сайт не буду искать, спрошу нейросети '
    'словами клиента, а названных конкурентов проверю поимённо и '
    'поставлю на график рядом с вами — даже тех, кого не назвали ни '
    'разу.\n\n'
    'А если в анкете указан конкретный район — «Москва, ЮЗАО», — я сам '
    'найду через поиск, кто работает в этой же нише рядом, и проверю '
    'их тем же порядком. Заодно четверть вопросов задам про район: '
